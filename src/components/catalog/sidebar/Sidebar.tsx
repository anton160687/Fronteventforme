...
function Sidebar() {
    ...
    const list = [
        ...
        { id: ++id, name: "Музыкальные группы", path: 'music', items_quantity: 770 },
        { id: ++id, name: "Свадебные платья", path: 'dresses', items_quantity: 100 },
        { id: ++id, name: "Мужские костюмы", path: 'dresses', items_quantity: 100 },
        { id: ++id, name: "Обручальные кольца", path: 'dresses', items_quantity: 100 },
        { id: ++id, name: "Платья подружек невесты", path: 'dresses', items_quantity: 100 },
    ...
    function renderCategoriesList() {
        return list.map((category) => (
            ...
            >
                <p className={path.split("/")[2] === category.path ? styles.active : undefined}>
                    {category.name}
                </p>
                <p className={path.split("/")[2] === category.path ? styles.active : undefined}>
    ...
    return (
        <>
            <Col
                ...
                lg={4}
                xl={4}
                className='border-top-lg border-end-lg shadow-sm p-4 rounded'
            >
                <h3>Категории</h3>

...
export const EMAIL_REQUIREMENTS = '[a-z]+[_?a-z0-9]+@[a-z]+\\.[a-z]{2,3}';
export const EMAIL_TITLE =
  'Адрес электронной почты имеет стандартный вид: обязательно наличие знаков до @ и после, а так же 2-3 символов после точки. Почта должна начинаться с латинской буквы';

...
export enum Paths {
  ...
  AccTariff = '/tariff',
  AccPayment = '/payment',
  AccMyBusiness = '/lk/provider/my',
  AccBusinessReviews = '/lk/provider/reviews',
  AddPlace = '/lk/provider/add/place',
  AddChoicePage = '/lk/provider/add',
  AddBusiness = '/lk/provider/add/business',
  AddProperty = '/addproperty',
  AddContacts = '/addcontacts',
  Success = '/lk/provider/add/success',
...
export const BreadCrumbsLinks = {
  ...
  Offers: { link: '/offers', name: 'Мои бизнесы' },
  ...
  AccMyBusiness: { link: '/my', name: '???' },
  AddChoicePage: { link: '/add', name: 'Выбрать бизнес' },
  AddBusiness: { link: '/business', name: 'Добавить бизнес' },

...
function BusinessReviewsPage() {
  ...
  return (
    <LKNavigation accountPageTitle={LKSectionsTitles.Reviews}>
      <>
        <p className='pt-1 mb-4'>Отзывы, которые вы получили, будут видны как здесь, так и в вашем общедоступном профиле.</p>
        <Tab.Container defaultActiveKey='reviewsAboutYou' transition={Fade}>
          ...
          <Nav variant='tabs' className='flex-column flex-sm-row align-items-stretch align-items-sm-start border-bottom mb-4'>
            <Nav.Item className='me-sm-3 mb-3'>
              <Nav.Link eventKey='reviewsAboutYou'>Отзывы о ваших бизнесах</Nav.Link>
            </Nav.Item>

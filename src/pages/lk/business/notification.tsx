...
function NotificationSetting() {
  ...
  return (
    <LKNavigation accountPageTitle={LKSectionsTitles.Notification}>
      <>
        <p className='pt-1 mb-4'>Получайте уведомления о новостях и событиях портала</p>
        <div className='py-2'>
        ...
        <div className='d-flex align-items-center border-top pt-4' onClick={handleDeletetAll}>
          <i className='fi-x-circle'/>
          <p className='fs-sm m-1 mt-0 mb-0'>

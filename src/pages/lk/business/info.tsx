import { ChangeEvent, FormEvent, FocusEvent, useEffect, useState, SetStateAction } from 'react';
...
function Info() {
  ...
  return (
    <>
      ...
      <DeleteModal show={show} setShow={setShow} message={'Вы действительно хотите безвозвратно удалить аккаунт?'} />
    </>
  )
}
